...
import img from "../../images/productmngt.jpg"
...
const PreviousBtn = (props) => {
  ...
  return (
    <div className={className} onClick={onClick}>
      ...
      <FontAwesomeIcon icon={faArrowAltCircleLeft} style={{ color: "#212121", fontSize: "45px" }} />
    </div>
  );
};
const NextBtn = (props) => {
  ...
  return (
    <div className={className} onClick={onClick}>
      ...
      <FontAwesomeIcon icon={faArrowAltCircleRight} style={{ color: "#212121", fontSize: "45px" }} />
    </div>
  );
};
const Testimonial = () => {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontStyle: "italic", marginTop: 25 }}>
        <span style={{ fontWeight: 500, color: "#212121" }}>PAULA WILSON</span> ,
        Media Analyst
      </p>
    </div>
  );
